...
namespace ng
{
	...
	void AdventureScene::handleCollisionContactBegin(nero::Collision collision)
	{
	    ...
	    if(collision.isColliding(CategoryPool.player, CategoryPool.ground) ||
	       collision.isColliding(CategoryPool.player, CategoryPool.box) ||
	       collision.isColliding(CategoryPool.player, CategoryPool.platform))
	    {
	        mPlayer.resetJump();
	    ...
	    if(collision.isColliding(CategoryPool.player, CategoryPool.coin))
	    {
	    ...
	    if(collision.isColliding(CategoryPool.player, CategoryPool.star))
	    {
